"use strict";
var KTImportKeys = function () {
    var e, t, o, r, a, i, n = [];
    return {
        init: function () {
            (e = document.querySelector("#kt_modal_Import_keys")) && (new bootstrap.Modal(e), t = document.querySelector("#kt_modal_Import_keys_stepper"), o = document.querySelector("#kt_modal_Import_keys_form"), r = t.querySelector('[data-kt-stepper-action="submit"]'), a = t.querySelector('[data-kt-stepper-action="next"]'), (i = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
                ...
                t ? t.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (CheckGameIsExistInSystem(o.querySelector('[name="layoutgamename"]').value) == true ? MessageBox("error", o.querySelector('[name="layoutgamename"]').value +" already exist in the system!") : e.goNext())
                        : Swal.fire({
                ...
                n[3].validate().then((function (t) {
                    ...
                    }), 2e3)) : MessageBox("error", "Sorry, looks like there are some errors detected, please try again.").then((function () {
                        KTUtil.scrollTop()
                    }))
                }))
...
function CheckGameIsExistInSystem(gamename) {
    if (gamename == "123") {
        return true;
    }
    else return false;
